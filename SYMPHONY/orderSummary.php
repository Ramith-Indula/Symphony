...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="box" style="background:<?php echo $bgcolor; ?>">
                    <?php echo $msg ?>; 
                    <a href="home.php" class="btn btn-primary" style="float: right;"><span class='glyphicon glyphicon-chevron-left'></span><strong>Back To Home</strong></a>
                </div>
            </div>
        </div>
    </body>
