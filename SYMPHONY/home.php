...
<html lang="en">
    ...
    <body>
        ...
        if (empty($_SESSION['username'])) {
            ...
            $bt = "<div Style='color:white;'><div class='dropdown'>
  <span>" . $_SESSION['username'] . "</span>
  <div class='dropdown-content'>
      <p><a href='myorders.php'>My Orders</a></p>
  </div>
</div>&nbsp;&nbsp;<a href='signout.php' class='btn btn-info'/>Sign Out</a>&nbsp;&nbsp;         <a href='shoppingCart.php'><span class='glyphicon glyphicon-shopping-cart'></span>Cart&nbsp;<span class='badge'>" . $size . "</span></a>
</div>
             ";
        }
        ?>
                    ...
                    <div class="col-lg-12 text-center">
                        <div id="carousel-example-generic" class="carousel slide">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="item">
                                    <img class="img-responsive img-full" src="img/slide-5.png" alt="">
                                </div>
                            </div>
                        ...
                        <h2>
                            <small>&#9958 &#9958 &#9958 &#9958 &#9958 </small>
                        </h2>
                        <h1>
